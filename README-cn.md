...
* 2014.6 - 至今  
    ...
    * 领导设计和开发为嵌入式音频产品设计和实现基于深度神经网络的轻量级关键词唤醒器(KWS)
    * 领导设计和开发基于深度神经网络的单麦克风降噪模型
    * 领导设计和开发为嵌入式音频产品设计和实现基于深度神经网络的语音活动检测(VAD)模型
    * 领导设计和开发通用智能音箱产品全自动化测试工具 
...
* **_领导开发适用于嵌入式音频产品的轻量级语音活动检测(VAD)系统 (2020 - 至今)_**
...
* **_领导开发适用于嵌入式音频产品的轻量级关键词唤醒器(KWS) (2019 - 2020)_**
...
* **_领导开发三星 Galaxy Home 智能音箱的全自动性能测试 (2018 - 2019)_**
...
* **_领导开发基于深度神经网络的单麦克风降噪算法 (2017 - 2018)_**  
