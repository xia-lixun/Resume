...
\begin{description}
    \item[2015.9 - present \hspace{0.2in} \textbf{Sr. Signal processing engineer, CoC Audio, Harman Suzhou, China}] \hfill \\
  %\vspace{0.1in}
  \begin{itemize}
  \item[--] Selective noise cancellation in automobile and consumer products based on machine learning approach.
  \item[--] Acoustic measurement
  \item[--] Agile product development, Scrum Alliance certified.
  \item[--] High performance signal processing code
  \item[--] Acoutic and phycoacoustic feature extraction for audio related machine learning
  \item[--] Pragmatic machine-learning algorithm application, data collection and pre-processing
  \item[--] Experience of advanced audio processing algorithms that lead the industry
  \item[--] Provisionary working style and team-work spirit
  \end{itemize}
  \vspace{0.4in}
  \item[2014.6 - 2015.5 \hspace{0.2in} \textbf{Sr. DSP engineer, Car Audio, Harman Suzhou, China}] \hfill \\
  %\vspace{0.1in}
  \begin{itemize}
