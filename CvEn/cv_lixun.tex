...
\begin{description}
  \item[2014.6 -        \hspace{0.2in} \textbf{Sr. Digital Signal Processing engineer,
                                         Core of Competence, Harman Suzhou, China}] \hfill \\
  %\vspace{0.1in}
  \begin{itemize}
  \item[--] Development of vehicle audio amplifiers for Europe and North America markets.
  \item[--] Development and maintenance of Audio Framework.
  \item[--] Novel HW/SW co-design of amplifier power supply for higher efficiency.
  \item[--] Hand-over EU/American project Active Noise Cancellation to Suzhou.
  ...
  \begin{itemize}
  \item[--] Start-up company making industrial instrument products. 
...
\section*{Education}
\begin{itemize}
\item 2008.9 - 2010.9 \hspace{0.1in} M.Sc. Integrated Electronic System Design, Chalmers University, Sweden.
\item 2001.9 - 2008.6 \hspace{0.1in} B/M.Sc. Control Science and Engineering, Central South University, China.
...
\begin{itemize}
\item Certified Scrum Master by Scrum Alliance.
...
\section*{Driver's License: C1, China P.R.}
